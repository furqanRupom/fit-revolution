...
const articlesPage = () => {
  ...
  useEffect(() => {
    axios.get("/api/articles").then((res) => setArticle(res.data.articles));
  }, []);
    ...
    <section>
      ...
      <section className="my-12 mb-8">
        ...
        <p className="leading-relaxed max-w-2xl text-sm mx-auto font-thin text-center pt-3">
          Explore techniques to spark innovative ideas in the fitness domain.
          Learn how to draw inspiration from personal experiences, current
          ...
          {article.map(({ author, title, description, image, date }) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <h6 className="text-sm italic text-gray-400  mb-4">{date}</h6>
