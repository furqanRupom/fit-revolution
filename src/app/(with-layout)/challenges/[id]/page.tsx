...
const ChallengeDetails: React.FC = ({ params }: any) => {
  const id = params?.id;
      ...
      {!loading ? (
        ...
        >
          ...
          <div className="z-50">
            ...
            >
              <div>
                <h3 className=" text-xl md:2xl lg:text-5xl font-[500] bg-gradient-to-tr from-rose-500 to-red-500 bg-clip-text text-transparent uppercase text-center pt-12">
                  {data?.challengeName}
                </h3>
